...
with open(normpath(join(DJANGO_ROOT, 'settings'))+"/secrets.json") as f:
...
ADMINS = (
    ('German', 'german@mywoding.com'),
    ('sebas', 'sebas@mywoding.com'),
)
...
#Override the default languages
LANGUAGES = (
    ('es', _('Español')),
    #('zh-cn', _('Chinese')),
    ('en', _('English')),
...
WSGI_APPLICATION = 'mywodingapp.wsgi.application'
